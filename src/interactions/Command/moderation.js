    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addUserOption(option => option.setName('user').setDescription('Üye Seç').setRequired(true))
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .setDescription('Rol verir.')
                .addUserOption(option => option.setName('user').setDescription('Üye Seç').setRequired(true))
                .addRoleOption(option => option.setName('role').setDescription('Alınacak Rol').setRequired(true))
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('nuke')
